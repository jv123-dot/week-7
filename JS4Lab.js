 ...
 *
 * ↓ YOUR CODE HERE ↓ */
const whatToEat = "pizza";
let whatToDrink = "water";
let myName = "Tom";
let friendName = "Billy";

//Question: Name a reason why you would use const instead of let.
//Answer: The const variable cannot be changed by code further down, and will give you and error if you try.
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`Hi, my name is ${myName}, and my friend ${friendName} and I went to lunch together and we ate ${whatToEat} and drank ${whatToDrink}.`)
...
//Answer: Messier, harder to read and a much bigger pain to write.
console.log("Hi, my name is" + ' ' + myName + "," + ' ' + "and my friend" + ' ' + friendName + ' ' + "and I went to lunch together and we ate" +' ' + whatToEat + ' ' + "and drank" + ' ' + whatToDrink + '.')
console.log(`--------------------------
Question 2a: Oh no`)
...
//Answer: It tells us that you cannot redeclare a const variable and it also tells us where in our code the original declaration was.
 ...
 * ↓ YOUR CODE HERE ↓ */
const lunchTime = (foodChoice, drinkChoice) => {return "Hi, my name is Tom, and my friend Billy and I went to lunch together and we ate" + ' ' + foodChoice + ' ' + "and drank" + ' ' + drinkChoice + "."}
console.log(lunchTime('Pizza','Water'))
...
//             return "Hi, my name is Tom, and my friend Billy and I went to lunch together and we ate" + ' ' + foodChoice + ' ' + "and drank" + ' ' + drinkChoice + "."
// } 
// console.log(lunchTime("pizza", "water"))
...
console.log(foodForTodayAndTomorrow("Spaghetti", "iced tea", lunchTime("burgers", "lemonade")))
